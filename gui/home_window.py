...
class HomeWindow(QWidget):
    def __init__(self):
        ...
        self.setFixedSize(800, 750)  # Fixed size, non-resizable
    ...
    def _create_buttons_section(self):
        ...
        self.upload_btn.setMinimumWidth(300)  # Set consistent minimum width
        layout.addWidget(self.upload_btn)
        
        # Library Button
        self.library_btn = ActionButton("📚 Open Library", "info")
        self.library_btn.clicked.connect(self.open_library)
        self.library_btn.setMinimumWidth(300)  # Set consistent minimum width
    ...
    def open_library(self):
        self.library_window = LibraryWindow(parent=self)
        self.hide()  # Hide home window
