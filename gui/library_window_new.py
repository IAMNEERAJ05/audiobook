...
class LibraryWindow(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setFixedSize(900, 600)  # Fixed size, non-resizable
    ...
    def go_back_to_home(self):
        ...
        if self.parent_window:
            ...
            self.parent_window.show()  # Show home window
    ...
    def open_player(self, item):
        ...
        self.player_window = PlayerWindow(book['book_id'], book['manifest'], parent=self)
        self.hide()  # Hide library window
        self.player_window.show()  # Show player window
